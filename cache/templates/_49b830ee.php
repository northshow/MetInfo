...
<link rel='stylesheet' type='text/css' href='http://localhost/M2/public/ui/v2/static/css/basic.css'>
...
?><?php endforeach;?>
                        <?php if($sub){ ?>
                    <ul class="met-product blocks blocks-100 blocks-xlg-5 blocks-md-4 blocks-sm-3 blocks-xs-2 ulstyle met-pager-ajax imagesize" data-scale='<?php echo $c['met_productimg_y'];?>x<?php echo $c['met_productimg_x'];?>' m-id="noset">
                        <?php defined('IN_MET') or exit('No permission'); ?>
...
<?php } ?>
                    ...
                    <?php }else{ ?>
                    <div class='h-100 text-xs-center font-size-20 vertical-align' m-id="noset"><?php echo $lang['nodata'];?></div>
                    <?php } ?>
